...
Status: M1-M15 implemented; M16 WU16-01 in progress
Date: 2026-08-13
...
| M16 | In progress — WU16-01 only | Controlled Device Software Updates; explicit, safety-governed APT standard upgrades. |
...
M13 was the final milestone in the prior roadmap. M14 and M15 are implemented. M15 operator validation completed successfully on both available Pi-Hub devices; separate plain-Debian coverage remains optional and is documented in its final closure review. M16 has started with WU16-01 design only; no APT metadata refresh or package mutation is authorized or implemented. M17 has not started.
