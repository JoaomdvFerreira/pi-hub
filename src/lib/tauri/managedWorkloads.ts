...
import type { ManagedWorkloadCard, ManagedWorkloadContinuation, ManagedWorkloadDeployment, ManagedWorkloadOperationRef, PreparedManagedWorkload } from "@/types/managedWorkloads";
